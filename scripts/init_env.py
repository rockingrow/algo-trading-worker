...
DESCRIPTIONS = {
  ...
  "MANUAL_ORDER_SYNC_ENABLED": "Adopt hand-opened terminal positions into tracking (FOREX)",
  "MANUAL_ORDER_STRATEGY": "Reserved strategy name for adopted manual orders (disjoint from magic map)",
  "MANUAL_ORDER_SYNC_INTERVAL": "Seconds between manual-order terminal scans",
