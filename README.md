...
```text
worker/
├── core/                # Market-agnostic signal processing
│   ├── base_signal_processor.py  # BaseSignalProcessor — shared NATS loop (Template Method)
...
│   ├── mt5_gateway_protocol.py   # Mt5GatewayProtocol (MetaTrader5 surface)
